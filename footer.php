...
<div class="container-fluid bg-dark text-white p-3 mt-5">
    ...
    <div class="mx-auto text-secondary" style="width: 340px;">
        ...
        <a href="#" class="link-secondary"><i class="fa fa-youtube-play" style="font-size:36px"></i></a>
        <a href="#" class="link-secondary"><i class="fa fa-instagram fa-fw" style="font-size:36px"></i></a>
        <a href="#" class="link-secondary"><i class="fa fa-whatsapp fa-fw" style="font-size:36px"></i></a>
        <a href="#" class="link-secondary"><i class="fa fa-twitter fa-fw" style="font-size:36px"></i></a>
        <a href="#" class="link-secondary"><i class="fa fa-snapchat-square fa-fw" style="font-size:36px"></i></a>
